...
public class DataAdaterCity extends RecyclerView.Adapter<DataAdaterCity.DataViewHolder> {
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private List<CityModel> mData = Collections.emptyList();
    private DataEventHandler mDataEventHandler;
    private AppPreferenceTools mAppPreferenceTools;


    public DataAdaterCity(Context context, DataEventHandler dataEventHandler) {
    ...
    public void updateAdapterData(List<CityModel> data) {
        this.mData = data;
    }
    ...
    public DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.dialog_row, parent, false);
        return new DataViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DataViewHolder holder, int position) {
        CityModel currentModel = mData.get(position);
        holder.mTxBody.setText(currentModel.cityname);
            ...
            mLyAction.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mDataEventHandler != null) {
                        mDataEventHandler.onDetailData(String.valueOf(mData.get(getAdapterPosition()).id_city), getAdapterPosition());
                    }
                }
            });
    ...
    public interface DataEventHandler {
        ...
        void onDetailData(String CityId, int position);
    }
