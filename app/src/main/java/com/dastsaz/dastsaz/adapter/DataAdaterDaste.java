...
public class DataAdaterDaste extends RecyclerView.Adapter<DataAdaterDaste.DataViewHolder>  {

    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private List<DasteModel> mData = Collections.emptyList();
    private DataEventHandler mDataEventHandler;
    private AppPreferenceTools mAppPreferenceTools;


    public DataAdaterDaste(Context context, DataEventHandler dataEventHandler) {
    ...
    public void updateAdapterData(List<DasteModel> data) {
        this.mData = data;
    }
    ...
    public void onBindViewHolder(DataViewHolder holder, int position) {
        DasteModel currentModel = mData.get(position);
        holder.mTxBody.setText(currentModel.groupname);
            ...
            mLyAction.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mDataEventHandler != null) {
                        mDataEventHandler.onDetailData(String.valueOf(mData.get(getAdapterPosition()).id_group), getAdapterPosition());
                    }
                }
            });
