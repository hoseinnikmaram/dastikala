...
public class CommentFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ViewManager.CustomView{
    ...
    @SuppressLint("ValidFragment")
    public CommentFragment(String idInEditMode) {
